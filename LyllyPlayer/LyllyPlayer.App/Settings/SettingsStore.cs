...
public static class SettingsStore
{
    ...
    private static AppSettings PatchFromJsonRoot(AppSettings loaded, JsonElement root)
    {
        ...
        return loaded with
        {
            ...
            BackgroundUserDefinedLyrics = loaded.BackgroundUserDefinedLyrics,
            ...
            YoutubeImportAppend = loaded.YoutubeImportAppend ?? GetBool(nameof(AppSettings.YoutubeImportAppend)),
            ExportM3uIncludeYoutube = loaded.ExportM3uIncludeYoutube ?? GetBool(nameof(AppSettings.ExportM3uIncludeYoutube)),
            ExportM3uPreferRelativePaths = loaded.ExportM3uPreferRelativePaths ?? GetBool(nameof(AppSettings.ExportM3uPreferRelativePaths)),
            ExportM3uIncludeLyllyMetadata = loaded.ExportM3uIncludeLyllyMetadata ?? GetBool(nameof(AppSettings.ExportM3uIncludeLyllyMetadata)),
            LocalImportAppend = loaded.LocalImportAppend ?? GetBool(nameof(AppSettings.LocalImportAppend)),
            LocalImportRemoveDuplicates = loaded.LocalImportRemoveDuplicates ?? GetBool(nameof(AppSettings.LocalImportRemoveDuplicates)),
            PlaylistDragDropAppend = loaded.PlaylistDragDropAppend ?? GetBool(nameof(AppSettings.PlaylistDragDropAppend)),
            PlaylistDragDropRemoveDuplicates = loaded.PlaylistDragDropRemoveDuplicates ?? GetBool(nameof(AppSettings.PlaylistDragDropRemoveDuplicates)),
            ...
            AudioNormalize = loaded.AudioNormalize ?? GetBool(nameof(AppSettings.AudioNormalize)),
            ...
            PlaylistWindowSortMode = loaded.PlaylistWindowSortMode ?? GetString(nameof(AppSettings.PlaylistWindowSortMode)),
            PlaylistWindowSortDirection = loaded.PlaylistWindowSortDirection ?? GetString(nameof(AppSettings.PlaylistWindowSortDirection)),
    ...
    private static readonly AppSettings AllNullSettingsInstance = new(
        ...
        PlaylistWindowSortMode: null,
        PlaylistWindowSortDirection: null,
        ...
        BackgroundUserDefinedLyrics: null,
        AppTitleMode: null,
        CustomAppTitle: null,
        ...
        YoutubeImportAppend: null,
        ExportM3uIncludeYoutube: null,
        ExportM3uPreferRelativePaths: null,
        ExportM3uIncludeLyllyMetadata: null,
        LocalImportAppend: null,
        LocalImportRemoveDuplicates: null,
        PlaylistDragDropAppend: null,
        PlaylistDragDropRemoveDuplicates: null,
        AudioQuality: null,
    ...
    private static AppSettings DefaultSettings()
        => new(
            ...
            PlaylistWindowFilter: null,
            PlaylistWindowSortMode: "None",
            PlaylistWindowSortDirection: "Asc",
            OptionsWindowLeft: null,
            OptionsWindowTop: null,
            OptionsWindowWidth: null,
            OptionsWindowHeight: null,
            ...
            YoutubeCookiesFromBrowser: null,
            YoutubeImportAppend: false,
            ExportM3uIncludeYoutube: true,
            ExportM3uPreferRelativePaths: false,
            ExportM3uIncludeLyllyMetadata: true,
            LocalImportAppend: false,
            LocalImportRemoveDuplicates: true,
            PlaylistDragDropAppend: true,
            PlaylistDragDropRemoveDuplicates: true,
    ...
    private static AppSettings ApplyDefaults(AppSettings s)
        => s with
        {
            ...
            BackgroundUserDefinedLyrics = s.BackgroundUserDefinedLyrics is { } ly ? NormalizeRectN(ly) : null,
            ...
            YoutubeImportAppend = s.YoutubeImportAppend ?? false,
            ExportM3uIncludeYoutube = s.ExportM3uIncludeYoutube ?? true,
            ExportM3uPreferRelativePaths = s.ExportM3uPreferRelativePaths ?? false,
            ExportM3uIncludeLyllyMetadata = s.ExportM3uIncludeLyllyMetadata ?? true,
            LocalImportAppend = s.LocalImportAppend ?? false,
            LocalImportRemoveDuplicates = s.LocalImportRemoveDuplicates ?? true,
            PlaylistDragDropAppend = s.PlaylistDragDropAppend ?? true,
            PlaylistDragDropRemoveDuplicates = s.PlaylistDragDropRemoveDuplicates ?? true,
            ...
            AudioNormalize = s.AudioNormalize ?? false,
